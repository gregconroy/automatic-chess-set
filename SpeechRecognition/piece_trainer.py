...
if not TRAIN_MODE:
    loaded = np.load('./CNN/piece_weights.npz')
...
if TRAIN_MODE:
    l2, weights = cnn.backProp(sample, expected, weights, 0.01, 200, 0.05, 1)
...
np.savez('./CNN/piece_weights_new.npz', *weights)
